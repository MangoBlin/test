...
public class ExportExcelUtil<T> {
    ...
    public void exportExcel(String title, Collection<T> dataset, OutputStream out, String version) {
        if (StringUtils.isEmpty(version) || EXCEL_FILE_2003.equals(version.trim())) {
            exportExcel2003(title, null, dataset, out, "yyyy-MM-dd");
//            exportExcel2003(title, null, dataset, out, "yyyy-MM-dd HH:mm:ss");
        } else {
            exportExcel2007(title, null, dataset, out, "yyyy-MM-dd");
//            exportExcel2007(title, null, dataset, out, "yyyy-MM-dd HH:mm:ss");
     ...
     * @param version  2003 或者 2007，不传时默认生成2003版本
     */
    public void exportExcel(HttpServletResponse response, String fileName, String title, String[] headers, Collection<T> dataset, String version) throws IOException {
        fileName = new String(fileName.replace(" ", "")
        ...
        if (StringUtils.isBlank(version) || EXCEL_FILE_2003.equals(version.trim())) {
            exportExcel2003(title, headers, dataset, os, "yyyy-MM-dd HH:mm:ss");
        } else {
            exportExcel2007(title, headers, dataset, os, "yyyy-MM-dd HH:mm:ss");
        }
        //刷新缓冲
        os.flush();
        os.close();
